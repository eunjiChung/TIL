...
class ViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        bannerCollectionView.selectItem(at: targetIndexPath, animated: true, scrollPosition: .centeredHorizontally)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case courseCollectionView:
            ...
            if let start = df.string(for: course.startDate), let end = df.string(for: course.endDate) {
                cell.coursePeriodLabel.text = "\(start) ~ \(end)"
            }
            // course tag
            cell.courseTagLabel.text = "#" + course.tags.joined(separator: " #")
            // course location
            cell.courseLocationLabel.text = course.location
