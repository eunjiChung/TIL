...
class PlayerScoreboardMoveEditorView: UIView {
    ...
    fileprivate func fillUI() {
        ...
        // 현재 설정돼있는 value를 setting한다
        // unowned self는 self가 nil이 아니고, 반드시 값을 가지고 있을거라고 예상하는 것
        ...
        viewModel.foulModeCount.bindAndFire { [unowned self] in self.foulCountLabel.text = $0 }
